...
path = r"E:/image/channel/"
im1 = Image.open(path + "origin.jpg")
...
#上色图保存
r_color.save(path + "1rr.jpg")
g_color.save(path + "1gg.jpg")
b_color.save(path + "1bb.jpg")

#直方图保存
r_hist.save(path + "1r_hist.jpg")
g_hist.save(path + "1g_hist.jpg")
b_hist.save(path + "1b_hist.jpg")
